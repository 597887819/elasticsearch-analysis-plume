...
import com.elisha.plume.service.PlumeTokenizerService;
...
public class AnalyzeContext {
     ...
     * 远程分词器
     */
    private PlumeTokenizerService plumeTokenizerService;
    /**
     * 配置
     */
    ...
    public AnalyzeContext(Reader reader, Configuration configuration) {
        this.input = reader;
        this.plumeTokenizerService = new PlumeTokenizerService();
    ...
    public Term next() throws IOException {
        ...
        List<Term> termList = plumeTokenizerService.getTextTokenizer(line, configuration);
        // 分词结果是空
        if (termList.size() == 0) {
            return null;
        }
