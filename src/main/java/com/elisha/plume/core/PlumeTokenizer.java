...
/**
 * 注意：Lucene要求Tokenizer必须是不可继承的，也即class自己要是final，或者incToken方法是final的。
 * 可以不在Java启动参数中传递“ea”进行规避，也即禁用assert能力。
 *
 * @author tenlee
 * @date 2020/5/28
 */
public final class PlumeTokenizer extends Tokenizer {

    private static final Logger logger = ESPluginLoggerFactory.getLogger(PlumeTokenizer.class.getName());
    ...
    public PlumeTokenizer(Configuration configuration) {
        super();
